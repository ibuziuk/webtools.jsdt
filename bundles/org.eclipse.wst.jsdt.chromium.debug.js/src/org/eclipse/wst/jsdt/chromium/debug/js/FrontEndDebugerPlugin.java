 ...
 */
public class FrontEndDebugerPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.wst.jsdt.chromium.debug.js"; //$NON-NLS-1$

	// The shared instance
	private static FrontEndDebugerPlugin plugin;
	
	public FrontEndDebugerPlugin() {
	}
	...
	public static FrontEndDebugerPlugin getDefault() {
		return plugin;
	}
