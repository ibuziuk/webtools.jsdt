...
public final class ChromiumUtil {
	...
	public static File findChromiumSystemPath() {
		...
		// TODO test for all OS - tested only on Ubuntu 16.04 / only chromium-browser is processed correctly
		...
		if (output.equals(EMPTY)) {
			String nodeFileName = CHROMIUM_BROWSER;
			if (isWindows) {
				nodeFileName = CHROME_WINDOWS;
			}
