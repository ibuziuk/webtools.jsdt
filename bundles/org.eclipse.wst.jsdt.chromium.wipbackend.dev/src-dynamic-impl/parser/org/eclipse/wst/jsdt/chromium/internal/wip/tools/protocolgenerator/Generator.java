...
import org.eclipse.wst.jsdt.chromium.internal.wip.tools.protocolgenerator.WipMetamodel.Command;
import org.eclipse.wst.jsdt.chromium.internal.wip.tools.protocolgenerator.WipMetamodel.Domain;
import org.eclipse.wst.jsdt.chromium.internal.wip.tools.protocolgenerator.WipMetamodel.Event;
import org.eclipse.wst.jsdt.chromium.internal.wip.tools.protocolgenerator.WipMetamodel.ObjectProperty;
import org.eclipse.wst.jsdt.chromium.internal.wip.tools.protocolgenerator.WipMetamodel.Parameter;
import org.eclipse.wst.jsdt.chromium.internal.wip.tools.protocolgenerator.WipMetamodel.StandaloneType;
...
class Generator {
  ...
  private class DomainGenerator {
    ...
    private void generateCommandParams(Command command, boolean hasResponse) throws IOException {
      ...
      additionalMemberBuilder.append("\t  public static final String METHOD_NAME = " +
          "org.eclipse.wst.jsdt.chromium.internal.wip.protocol.BasicConstants.Domain." +
      ...
      if (hasResponse) {
        ...
        additionalMemberBuilder.append(
            ...
            "org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.WipCommandResponse.Data data, " +
            "org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input." +
            PARSER_ROOT_INTERFACE_NAME + " parser) " +
            "throws org.eclipse.wst.jsdt.chromium.internal.protocolparser.JsonProtocolParseException {\n");
    ...
    StandaloneTypeBinding createStandaloneOutputTypeBinding(StandaloneType type,
      ...
      return switchByType(type, TypedObjectAccess.FOR_STANDALONE,
        ...
        public StandaloneTypeBinding visitEnum(List<String> enumConstants) {
        	return createStandaloneEnumInputTypeBinding(getType(), enumConstants, TypeData.Direction.OUTPUT);
        }
    ...
    private void generateEvenData(Event event) throws IOException {
      ...
      eventTypeMemberText.append(
          "\t  public static final org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.WipEventType<" +
          fullName +
          "> TYPE\n\t      = new org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.WipEventType<" +
          fullName +
        ...
        public BoxableType generateNestedObject(String description,
          ...
          if (propertyList == null) {
            ...
            builder.append("\t  public interface " + objectName +
                " extends org.eclipse.wst.jsdt.chromium.internal.protocolparser.JsonObjectBased {\n");
            builder.append("\t  }\n");
          } else {
            builder.append("\t  @org.eclipse.wst.jsdt.chromium.internal.protocolparser.JsonType\n");
            builder.append("\t  public interface " + objectName + " {\n");
  ...
  private String generateMethodNameSubstitute(String originalName, IndentWriter output)
    ...
    output.append("\t  @org.eclipse.wst.jsdt.chromium.internal.protocolparser.JsonField(jsonLiteralName=\"" +
        originalName + "\")\n");
